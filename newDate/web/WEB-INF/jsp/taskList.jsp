...
<div <c:if test="${totalPage ==1 }">style="display: none;" </c:if>>
    <ul class="pagination pagination-lg">
        <li class="page-item <c:if test="${currentPage == 1}">disabled</c:if>">
            <a class="page-link"
               href="javascript:<c:if test="${currentPage >1}">goPage(${currentPage-1})</c:if>;">&laquo;</a>
        </li>
        <c:if test="${currentPage-2>0}">
            <li class="page-item ">
                <a class="page-link" href="javascript:goPage(${currentPage-2});">${currentPage-2}</a>
            </li>
        </c:if>
        <c:if test="${currentPage-1>0}">
            <li class="page-item ">
                <a class="page-link" href="javascript:goPage(${currentPage-1});">${currentPage-1}</a>
            </li>
        </c:if>
        ...
        <li class="page-item <c:if test="${currentPage == totalPage}">disabled</c:if>">
            <a class="page-link"
               href="javascript:<c:if test="${currentPage < totalPage}">goPage(${currentPage+1})</c:if>;">&raquo;</a>
        </li>
    </ul>
</div>
<div class="well">
