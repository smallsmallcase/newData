...
public class TestDataMapService {
    ...
    /**表名映射*/
    public final static Map<String,String> TABLENAMEMAP = new HashMap<>();
    ...
    private final String[]PregnantBigCheckEng={"k","na","cl","ca","p","co2","tp","alb","gb","whiteballratio","prealbumin","tba","tb","brd","urd","alt","got","alk","gt","ldh","ce","glucose","bun","cr","ua","cystain","p_time"};
